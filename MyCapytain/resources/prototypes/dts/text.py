...
#Todo reprendre ce fichier et voir si faut reprendre la partie inventory
class PrototypeDtsNode(InteractiveTextualNode):
    ...
    def __init__(self, identifier = None, **kwargs):
        super(PrototypeDtsNode, self).__init__(identifier=identifier, **kwargs)
...
class PrototypeDtsPassage(PrototypeDtsNode):
    ...
    def __init__(self, **kwargs):
        super(PrototypeDtsPassage, self).__init__(**kwargs)
...
class PrototypeDtsText(PrototypeDtsNode):
    """ A CTS CtsText
    """

    def __init__(self, citation=None, metadata=None, **kwargs):
        super(PrototypeDtsText, self).__init__(citation=citation, metadata=metadata, **kwargs)
        self._cts = None
